...
@section("content")
    ...
    <form method="post" action="{{route("generate_p9_step_4_add_tenant_wife")}}">
        @csrf
        ...
        <div class="current" data-kt-stepper-element="content">
            ...
            <div class="w-100">
                ...
                <div class="pb-10 pb-lg-15">
                    <!--begin::Title-->
                    <h2 class="fw-bold text-dark">Add Tenant Wife</h2>
                </div>
                ...
                <div class="w-100">
                    <div class="row col-md-12">
                        ...
                        <div class="col">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder=""
                                   name="tenant_name" required value=""/>
                        </div>
