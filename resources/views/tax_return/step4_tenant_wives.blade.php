        ...
        <div class="current" data-kt-stepper-element="content">
            ...
            <div class="w-100">
                ...
                <div class="pb-10 pb-lg-15">
                    <!--begin::Title-->
                    <h2 class="fw-bold text-dark">Tenant Wife/Wives Details</h2>
                    <a href="{{route("generate_p9_step_4_add_tenant_wife",['code'=>request()->code])}}" class="btn btn-primary pull-right" style="float: right !important;"> <i class="fa fa-plus"></i> Add</a>
                </div>
                ...
                <div class="w-100">
                    <table class="w-100">
                        ...
                        <tbody>
                        @forelse($tenant_wives as $tenant)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-inline">
                                        ...
                                        <a href="{{route("generate_p9_step_4_delete_tenant_wife",["id"=>$tenant->id,'code'=>request()->code])}}" class="btn btn-sm btn-danger"><i class="fa fa-trash-alt"></i></a>
                                    </div>
                                </td>
                            </tr>
