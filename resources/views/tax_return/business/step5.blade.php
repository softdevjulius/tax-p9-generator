...
@section("content")
    ...
    <form action="{{route("business_step_5")}}" method="post">
        @csrf
        ...
        <div class="current" data-kt-stepper-element="content">
            ...
            <div class="w-100">
                ...
                <div class="pb-10 pb-lg-15">
                    <!--begin::Title-->
                    <h2 class="fw-bold text-dark">Book a meeting</h2>
                    <!--end::Title-->
                    <!--begin::Notice-->

                    <!--end::Notice-->
                </div>
                <a href="https://calendly.com/dennis-217/30min"> Book Now</a>
            </div>
            <!--end::Wrapper-->
        </div>
        ...
        <div class="d-flex flex-stack pt-15">
            ...
            <div>
                ...
                <button type="submit" class="btn btn-lg btn-primary">Finish
