...
@section("content")
    ...
    <form action="{{route("business_step_2")}}" method="post">
        @csrf
        ...
        <div class="current" data-kt-stepper-element="content">
            ...
            <div class="w-100">
                ...
                <div class="pb-10 pb-lg-15">
                    <!--begin::Title-->
                    <h2 class="fw-bold text-dark"> Revenue Streams </h2>
                    <!--end::Title-->
                    <!--begin::Notice-->
                ...
                <div class="mb-10 fv-row">
                    @forelse($streams as $stream)
                        <div class="form-check form-check-custom form-check-solid">
                            <input name="stream[{{$stream->id}}]" class="form-check-input" type="checkbox" value="{{$stream->id}}" id="billing{{$stream->id}}"  data-kt-settings-notification="email" />
                            <label class="form-check-label ps-{{$stream->id}}" for="billing{{$stream->id}}">{{$stream->name}} </label>
                        </div>
                        </br>
                    @empty
                    @endforelse
...
{{--                    <div class="form-check form-check-custom form-check-solid">--}}
{{--                        <input class="form-check-input" type="checkbox" value="" id="billing2"  data-kt-settings-notification="phone" />--}}
{{--                        <label class="form-check-label ps-2" for="billing2">Employment</label>--}}
{{--                    </div>--}}
{{--                    </br>--}}
{{--                    <div class="form-check form-check-custom form-check-solid">--}}
{{--                        <input class="form-check-input" type="checkbox" value="" id="billing2"  data-kt-settings-notification="phone" />--}}
{{--                        <label class="form-check-label ps-2" for="billing2">Capital Gains</label>--}}
{{--                    </div>--}}
{{--                    </br>--}}
{{--                    <div class="form-check form-check-custom form-check-solid">--}}
{{--                        <input class="form-check-input" type="checkbox" value="" id="billing2"  data-kt-settings-notification="phone" />--}}
{{--                        <label class="form-check-label ps-2" for="billing2">Royalty</label>--}}
{{--                    </div>--}}
{{--                    </br>--}}
{{--                    <div class="form-check form-check-custom form-check-solid">--}}
{{--                        <input class="form-check-input" type="checkbox" value="" id="billing2"  data-kt-settings-notification="phone" />--}}
{{--                        <label class="form-check-label ps-2" for="billing2">Business</label>--}}
{{--                    </div>--}}
{{--                    </br>--}}
{{--                    <div class="form-check form-check-custom form-check-solid">--}}
{{--                        <input class="form-check-input" type="checkbox" value="" id="billing2"  data-kt-settings-notification="phone" />--}}
{{--                        <label class="form-check-label ps-2" for="billing2">Investmemts</label>--}}
{{--                    </div>--}}
