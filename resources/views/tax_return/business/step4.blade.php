...
@section("content")
    ...
    <form action="{{route("business_step_4")}}" method="post">
        @csrf
        ...
        <div class="current" data-kt-stepper-element="content">
            ...
            <div class="w-100">
                ...
                <div class="fv-row mb-10">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input name="phone" type="number" class="form-control form-control-lg form-control-solid" value=" " />
                    <!--end::Input-->
                </div>
                <div class="fv-row mb-10">
                    <!--begin::Label-->
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input name="amount" type="number" step="0.01" class="form-control form-control-lg form-control-solid" value="100 " />
                    <!--end::Input-->
                </div>
