...
@section("content")
    ...
    <form action="{{route("generate_p9_step_3")}}" method="post">
        @csrf
        ...
        <div class="current" data-kt-stepper-element="content">
            ...
            <div class="w-100">
                ...
                <div class="pb-10 pb-lg-12">
                    <!--begin::Title-->
                    <h2 class="fw-bold text-dark">Allowance and Deductions</h2>
                    <!--end::Title-->
                    <!--begin::Notice-->
               ...
               <div class="allowances">
                ...
                <div class="row">
                    <button type="button" class="btn btn-primary add_allowance"> <i class="fa fa fa-plus"></i> Add allowance</button>
                </div>
